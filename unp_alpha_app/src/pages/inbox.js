...
function InboxPage() {
  ...
  const list = [
    ...
    {"sender": "Max", "receiver": "Christina", "message":"It was great meeting you last week!"},
    {"sender": "Jhon", "receiver": "Christina", "message":"Does your son like to play baseball? May be we can plan something like that"},
    {"sender": "Julie", "receiver": "Christina", "message":"Hi Christna! I found our sons go to same class. Do you like to meet on park next week? We can introduce our son to each other "}, 
    {"sender": "Max", "receiver": "Christina", "message":"It was great meeting you last week!"},
    {"sender": "Jhon", "receiver": "Christina", "message":"Does your son like to play baseball? May be we can plan something like that"}
