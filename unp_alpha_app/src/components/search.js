...
function Search() {
  ...
  return (
    ...
    <h3 style={{marginBottom:20, fontSize:25}}>Find Friends For Your Children In Your Locality!</h3>
    <Form  
    labelAlign='left'    
      labelCol={{
        span: 8,
  ...
  return (
    ...
    <Descriptions.Item label="firstname">First Name: {item.first_name}</Descriptions.Item> <br />
        ...
        <Descriptions.Item label="location">Location: {item.location}</Descriptions.Item><br />
        <Descriptions.Item label="school">School:   {item.school}</Descriptions.Item><br />
        <Descriptions.Item label="street">Street: {item.street}</Descriptions.Item><br />
    </Card>
  </div>
  </Descriptions>
</div>
